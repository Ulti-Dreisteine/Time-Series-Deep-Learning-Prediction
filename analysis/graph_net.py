...
def load_ccf_results():
	with open('../tmp/total_time_delay_ccf_results.json', 'r') as f:
...
if __name__ == '__main__':
	...
	significant_time_ranges, time_delay_peaks = time_delays_and_significant_time_ranges(
		columns, target_columns, total_ccf_results, detect_sep_loc)
	...
	nx.draw_networkx_edges(
		g, pos, edge_width = 5 * weights, edge_color = weights, edge_cmap = plt.cm.Blues, arrowsize = 10)
